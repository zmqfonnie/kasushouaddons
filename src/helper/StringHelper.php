...
class StringHelper
{
    ...
    */
     ...
     * @return array 生成卡密
     */
    public static function getCardId($num = 1, $length = 10, $prifix = '')
    {
     ...
     * @return array
     */
    public static function getCardPwd($num = 1, $length = 16)
    {
        $pwd = array();
        for ($i = 0; $i < $num; $i++) {
            //生成基本随机数
            $charid = substr(MD5(uniqid(mt_rand(), true)), 8, 16) . self::randomNum($length, '2');
