...
namespace kasushou\curd\service;
...
class CurdService
{
     ...
     * @var string
     */
    protected $tablePrefix = ' xinmeng_';
    /**
     * 数据库名
     * @var string
     */
    protected $database = 'kasushou';
    ...
    public function __construct(array $config)
    {
        ...
        $this->dir = __DIR__;
        $this->tplPath = $this->rootPath . 'vendor' . DS . 'kasushou' . DS . 'fun-addons' . DS . 'src' . DS . 'curd' . DS . 'tpl' . DS;
